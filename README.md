...
### Step 2: Paste it into the Edit area
1. Click back on the **Edit** tab on your screen.
2. Select everything currently inside that text box and delete it.
3. Paste the new text you just copied from above.

### Step 3: Check the Preview
Now click back on the **Preview** tab. You will immediately see it transform into a beautiful page with bold titles, neat sections, and gray code blocks! Click the green **Commit changes...** button once you are happy with it.
